...
robot.followline(speed=10, distance=72, port=3, right=True, black=15, white=85, delta=-35, factor=0.4)
...
robot.followline(speed=10, distance=43, port=3, right=True, black=15, white=85, delta=-35, factor=0.4)